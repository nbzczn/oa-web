                    ...
                    <div className="col-4">
                        <label className="color-option-check">
                            ...
                            <span className="color-option-item bg-color-page">
                                ...
                                <span className="bg-color-dark item-header"></span>
                                <span className="bg-color-light item-header"></span>
                                <span className="bg-color-dark"></span>
                            </span>
                        </label>
                        <label className="color-option-check">
                            ...
                            <span className="color-option-item bg-color-page">
                                <span className="overlay"><span className="material-icons">check</span></span>
                                <span className="bg-color-primary item-header"></span>
                                <span className="bg-color-light item-header"></span>
                                <span className="bg-color-dark"></span> 
                            </span>
                        </label>
                        <label className="color-option-check">
                            ...
                            <span className="color-option-item bg-color-page">
                                <span className="overlay"><span className="material-icons">check</span></span>
                                <span className="bg-color-success item-header"></span>
                                <span className="bg-color-light item-header"></span>
                                <span className="bg-color-dark"></span> 
                            </span>
                        </label>
                        <label className="color-option-check">
                            ...
                            <span className="color-option-item bg-color-page">
                                <span className="overlay"><span className="material-icons">check</span></span>
                                <span className="bg-color-info item-header"></span>
                                <span className="bg-color-light item-header"></span>
                                <span className="bg-color-dark"></span> 
                            </span>
                        </label>
                        <label className="color-option-check">
                            ...
                            <span className="color-option-item bg-color-page">
                                <span className="overlay"><span className="material-icons">check</span></span>
                                <span className="bg-color-warning item-header"></span>
                                <span className="bg-color-light item-header"></span>
                                <span className="bg-color-dark"></span> 
                            </span>
                        </label>
                        <label className="color-option-check">
                            ...
                            <span className="color-option-item bg-color-page">
                                <span className="overlay"><span className="material-icons">check</span></span>
                                <span className="bg-color-danger item-header"></span>
                                <span className="bg-color-light item-header"></span>
                                <span className="bg-color-dark"></span> 
                            </span>
                        </label>
                    ...
                    <div className="col-4">
                        <label className="color-option-check">
                            ...
                            <span className="color-option-item bg-color-page">
                                ...
                                <span className="bg-color-dark item-header"></span>
                                <span className="bg-color-dark item-header"></span>
                                <span className="bg-color-light"></span> 
                            </span>
                        </label> 
                        <label className="color-option-check">
